  ...
  return (
    <div className="relative inline-block mx-auto">
      ...
      {showGlow && (
        <motion.div
          ...
          style={{
            ...
            marginBlock: "-10px",
            background:
              "linear-gradient(90deg, rgba(124, 58, 237, 0.8) 0%, rgba(236, 72, 153, 0.8) 50%, rgba(234, 88, 12, 0.8) 100%)",
          }}
          initial={{ opacity: 0 }}
          animate={{
            opacity: [0.4, 0.7, 0.4],
      ...
      >
        <Link href={href}>
          <motion.button
            className={`relative px-5 py-2.5 bg-white dark:bg-[linear-gradient(to_right,_#8b5cf6,_#ec4899,_#3b82f6)] text-black dark:text-black rounded-full font-medium text-lg flex items-center gap-2 cursor-pointer ${className}`}
          >
            <span>{children}</span>
